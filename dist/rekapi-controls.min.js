 ...
 */
(function(g){function h(a){var c,d,f,b;c=a.kapi;d=a.$container.find(".rekapi-scrubber-play");f=a.$container.find(".rekapi-scrubber-pause");b=a.$container.find(".rekapi-scrubber-stop");d.on("click",function(a){a.preventDefault();c.play()});f.on("click",function(a){a.preventDefault();c.pause()});b.on("click",function(a){a.preventDefault();c.stop();c.update(0)});c.on("playStateChange",function(){a.syncPlayStateButtons()});c.on("stop",function(){a.resetScrubber()});c.on("afterUpdate",function(){a.updateScrubber()})}
