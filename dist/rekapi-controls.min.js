 ...
 */
(function(g,e){function h(a){var c,d,b,e;c=a.kapi;d=a.$container.find(".rekapi-scrubber-play");b=a.$container.find(".rekapi-scrubber-pause");e=a.$container.find(".rekapi-scrubber-stop");d.on("click",function(a){a.preventDefault();c.play()});b.on("click",function(a){a.preventDefault();c.pause()});e.on("click",function(a){a.preventDefault();c.stop();c.update(0)});c.on("playStateChange",function(){a.syncPlayStateButtons()});c.on("stop",function(){a.resetScrubber()});c.on("afterUpdate",function(){a.updateScrubber()})}
